export default {
  ...
  remoteUrlHint: "Usa HTTPS si configuras una clave API. HTTP solo se permite para túneles SSH a localhost/127.0.0.1. Debe exponer /health y /v1/chat/completions.",
