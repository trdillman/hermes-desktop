export default {
  ...
  remoteUrlHint: "Use HTTPS ao configurar uma chave de API. HTTP só é permitido para túneis SSH em localhost/127.0.0.1. Deve expor /health e /v1/chat/completions.",
